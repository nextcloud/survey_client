OC.L10N.register(
    ...
    "Statistic <em>(number of: Files, users, storages per type, comments and tags)</em>" : "Statistik: <em>(Anzahl: Dateien, Nutzer, Speicherorte nach Typ, Kommentare und Tags)</em>",
