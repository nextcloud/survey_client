OC.L10N.register(
    ...
    "Sends anonymized data to Nextcloud to help us to improve Nextcloud. You\n\t\talways have full control over the content sent to Nextcloud and can disable\n\t\tit again at any time." : "Šalje anonimizirane podatke u Nextcloud kako bi nam pomoglo poboljšati Nextcloud. Vi \n\t\tuvijek imate potpunu kontrolu nad sadržajem koji se šalje u Nextcloud i \n\t\tmožete to u bilo kojem trenutku ponovno onemogućiti.",
    ...
    "We take your privacy seriously. Sending data is disabled by default, and should you choose to turn it on, it will be anonymized first, and you are given the option of what things to share. Upon receiving a report, the previous one is removed. To delete the stored usage data, upload an empty report by unchecking all of the boxes then sending a new report." : "Vaša privatnost nam je važna. Slanje podataka zadano je onemogućeno, a ako ga odlučite uključiti, podaci će prvo biti anonimizirani te ćete imati mogućnost odabrati što želite dijeliti. Nakon zaprimanja izvješća, prethodno se uklanja. Za brisanje pohranjenih podataka o korištenju pošaljite prazno izvješće tako da odznačite sve stavke i potom pošaljete novo izvješće.",
