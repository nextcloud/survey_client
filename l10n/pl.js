OC.L10N.register(
    ...
    "You can help improve Nextcloud by sending us some data about your current setup and usage." : "Możesz nam pomóc ulepszyć Nextcloud, przesyłając nam dane dotyczące bieżącej konfiguracji i użytkowania.",
    "We take your privacy seriously. Sending data is disabled by default, and should you choose to turn it on, it will be anonymized first, and you are given the option of what things to share. Upon receiving a report, the previous one is removed. Upload a clean report to delete all data currently stored on the server" : "Poważnie traktujemy Twoją prywatność. Wysyłanie danych jest domyślnie wyłączone, a jeśli zdecydujesz się je włączyć, najpierw zostaną zanonimizowane, a Ty będziesz miał możliwość wyboru, co chcesz udostępniać. Po otrzymaniu raportu poprzedni jest usuwany. Prześlij czysty raport, aby usunąć wszystkie dane aktualnie przechowywane na serwerze.",
