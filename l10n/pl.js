OC.L10N.register(
    ...
    "Number of shares <em>(per type and permission setting)</em>" : "Liczba udostępnień <em>(według typu i ustawienia uprawnień)</em>",
    ...
    "We take your privacy seriously. Sending data is disabled by default, and should you choose to turn it on, it will be anonymized first, and you are given the option of what things to share. Upon receiving a report, the previous one is removed. To delete the stored usage data, upload an empty report by unchecking all of the boxes then sending a new report." : "Poważnie traktujemy Twoją prywatność. Wysyłanie danych jest domyślnie wyłączone, a jeśli zdecydujesz się je włączyć, zostaną one najpierw zanonimizowane, a Ty otrzymasz możliwość wyboru, jakie rzeczy chcesz udostępnić. Po otrzymaniu raportu poprzedni jest usuwany. Aby usunąć zapisane dane dotyczące użytkowania, prześlij pusty raport, odznaczając wszystkie pola, a następnie wysyłając nowy raport.",
