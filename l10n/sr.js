OC.L10N.register(
    ...
    "You can help us to improve Nextcloud be sending us some data about your current setup and usage." : "Можете нам помоћи да побољшамо Некстклауд тако што ћете послати неке податке о Вашим тренутним подешавањима и употреби.",
