OC.L10N.register(
    ...
    "We take your privacy seriously. Sending data is disabled by default, and should you choose to turn it on, it will be anonymized first, and you are given the option of what things to share. Upon receiving a report, the previous one is removed. To delete the stored usage data, upload an empty report by unchecking all of the boxes then sending a new report." : "Ми узимамо вашу приватност веома озбиљно. Слање података је подразумевано искључено и, уколико одаберете да га укључите, прво ће бити анонимизовано и биће вам дата опција шта да поделите. По примању извештаја, претходни се уклања. Ако желите да обришете све претходно сачуване податке о коришћењу, отпремите празан извештај тако што одштилклирате све опције па пошаљете нови извештај.",
