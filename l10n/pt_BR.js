OC.L10N.register(
    ...
    "We take your privacy seriously. Sending data is disabled by default, and should you choose to turn it on, it will be anonymized first, and you are given the option of what things to share. Upon receiving a report, the previous one is removed. To delete the stored usage data, upload an empty report by unchecking all of the boxes then sending a new report." : "Levamos a sua privacidade a sério. O envio de dados está desabilitado por padrão e caso você opte por ativá-lo, ele será anonimizado primeiro e você terá a opção de quais itens compartilhar. Ao receber um relatório, o anterior é removido. Para excluir os dados de uso armazenados, carregue um relatório vazio desmarcando todas as caixas e enviando um novo relatório.",
