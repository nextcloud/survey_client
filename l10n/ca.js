OC.L10N.register(
    ...
    "Statistic <em>(number of: files, users, storages per type, comments and tags)</em>" : "Estadística <em>(nombre de: fitxers, usuaris, emmagatzemaments per tipus, comentaris i etiquetes)</em>",
    ...
    "You can help us to improve Nextcloud be sending us some data about your current setup and usage." : "Podeu ajudar a millorar Nextcloud enviant-nos algunes dades sobre la vostra configuració i ús actual.",
