OC.L10N.register(
    ...
    "We take your privacy seriously. Sending data is disabled by default, and should you choose to turn it on, it will be anonymized first, and you are given the option of what things to share. Upon receiving a report, the previous one is removed. To delete the stored usage data, upload an empty report by unchecking all of the boxes then sending a new report." : "Мы серьезно относимся к вашей конфиденциальности. Отправка данных отключена по умолчанию, и если вы решите включить ее, она сначала будет анонимизирована, и вам будет предоставлена ​​возможность выбора того, чем поделиться. После получения отчета предыдущий удаляется. Чтобы удалить сохраненные данные об использовании, загрузите пустой отчет, сняв все флажки, а затем отправьте новый отчет.",
