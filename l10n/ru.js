OC.L10N.register(
    ...
    "Not now" : "Не сейчас",
    "Never ask again" : "Никогда больше не спрашивать",
    "Never" : "Никогда",
    ...
    "Sends anonymized data to Nextcloud to help us to improve Nextcloud. You\n\t\talways have full control over the content sent to Nextcloud and can disable\n\t\tit again at any time." : "Отправлять обезличенные данные в Nextcloud, чтобы помочь нам\nулучшить Nextcloud. Вы всегда имеете полный контроль над\nсодержимым, отправляемым в Nextcloud, и можете отключить\nего передачу в любое время.",
    ...
    "We take your privacy seriously. Sending data is disabled by default, and should you choose to turn it on, it will be anonymized first, and you are given the option of what things to share. Upon receiving a report, the previous one is removed. To delete the stored usage data, upload an empty report by unchecking all of the boxes then sending a new report." : "Мы серьезно относимся к вашей конфиденциальности. Отправка данных отключена по умолчанию, и если вы решите включить её, она сначала будет анонимизирована, и вам будет предоставлена ​​возможность выбора того, чем поделиться. После получения отчёта предыдущий удаляется. Чтобы удалить сохранённые данные об использовании, загрузите пустой отчёт, сняв все флажки, а затем отправьте новый отчёт.",
