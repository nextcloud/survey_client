OC.L10N.register(
    ...
    "We take your privacy seriously. Sending data is disabled by default, and should you choose to turn it on, it will be anonymized first, and you are given the option of what things to share. Upon receiving a report, the previous one is removed. Upload a clean report to delete all data currently stored on the server" : "Zure pribatutasuna babesten dugu. Datuak bidaltzea desaktibatuta dator modu lehenetsian, eta gaitzen baduzu, datuak anonimo egingo dira lehenengo eta zer partekatu aukeratu dezakezu. Txostena jasotzen dugunean, aurrekoa ezabatu egiten dugu. Txosten huts bat bidali datu guztiak ezabatu ditzagun",
