OC.L10N.register(
    ...
    "App list <em>(for each app: name, version, enabled status)</em>" : "Liste des applications <em>(pour chaque application : nom, version, statut activé)</em>",
    ...
    "Help improve Nextcloud" : "Aidez-vous à améliorer Nextcloud",
