OC.L10N.register(
    ...
    "Statistic <em>(number of: files, users, storages per type, comments and tags)</em>" : "통계<em>(파일, 사용자, 종류별 저장소, 댓글, 태그 개수)</em>",
    ...
    "You can help us to improve Nextcloud be sending us some data about your current setup and usage." : "Nextcloud 개선을 돕기 위해서 설치 및 사용 통계를 익명으로 전송할 수 있습니다.",
