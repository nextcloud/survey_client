OC.L10N.register(
    ...
    "An error occurred while sending your report." : "Sinu aruande saatmisel tekkis viga.",
    ...
    "Encryption information <em>(is it enabled?, what is the default module)</em>" : "Krüptimisteave <em>(kas on sisse lülitatud?, mis on vaikemoodul)</em>",
    "Number of shares <em>(per type and permission setting)</em>" : "Jagamiste hulk <em>(tüübi kohta ja õiguste seadistused)</em>",
    "PHP environment <em>(version, memory limit, max. execution time, max. file size)</em>" : "PHP keskkond <em>(versioon, mälupiirang, maksimaalne täitmisaeg, maksimaalne failisuurus)</em>",
    "Server instance details <em>(version, memcache used, status of locking/previews/avatars)</em>" : "Konkreetse serveri üksikasjad <em>(versioon, memcache'i kasutamine, lukustamise/eelvaadete/tunnuspiltide olek)</em>",
    ...
    "Usage survey" : "Kasutusuuring",
    "Help improve Nextcloud" : "Aita muuta Nextcloudi paremaks",
    ...
    "Send usage" : "Saada kasutuse aruanne",
    "Not now" : "Mitte praegu",
    "Never ask again" : "Ära iialgi küsi uuesti",
    "Never" : "Mitte kunagi",
    ...
    "Send new report now" : "Saada kohe uus aruanne",
    "Send usage survey monthly" : "Saada kasutuse aruanne igakuiselt",
    "Data to send" : "Andmed, mida saata",
    "Last report" : "Viimane aruanne",
