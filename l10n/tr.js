OC.L10N.register(
    ...
    "Server instance details <em>(version, memcache used, status of locking/previews/avatars)</em>" : "Sunucu kopyası bilgileri <em>(sürüm, kullanılan memcache, kilitleme/önizleme/avatarlar durumu)</em>",
    "Statistic <em>(number of: Files, users, storages per type, comments and tags)</em>" : "İstatistikler <em>(dosya, kullanıcı, türlerdeki depolama, yorum ve etiket sayıları)</em>",
