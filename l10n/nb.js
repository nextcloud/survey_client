OC.L10N.register(
    ...
    "Server instance details <em>(version, memcache used, status of locking/previews/avatars)</em>" : "Tjenerinstallasjonsdetaljer <em>(versjon, hurtigminne brukt, status for låsing/forhåndsvisninger/avatarer)</em>",
