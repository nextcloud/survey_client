OC.L10N.register(
    ...
    "Statistic <em>(number of: files, users, storages per type, comments and tags)</em>" : "Statistikk<em>(antall: filer, brukere, lager per type, kommenarer og merkelapper)</em>",
