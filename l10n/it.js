OC.L10N.register(
    ...
    "Statistic <em>(number of: Files, users, storages per type, comments and tags)</em>" : "Statistiche <em>(numero di: file, utenti, archiviazioni per tipo, commenti ed etichette)</em>",
